...
namespace E_Sports_Pvt_Ltd.Pages.player
{
    ...
    public partial class playerregister : System.Web.UI.Page
    {
        ...
        protected void reg_btn_Click(object sender, EventArgs e)
        {
            ...
            {
                string query = "select * from playerregister where username = '" + uname + "'";
                ...
                if (dt1.Rows.Count == 0)
                {
                    ...
                    cmd.CommandText = "Insert into playerregister (name,mobile,username,password)" +
