...
namespace E_Sports_Pvt_Ltd.Pages.player
{
    ...
    public partial class playerlogin : System.Web.UI.Page
    {
        ...
        protected void login_btn_Click(object sender, EventArgs e)
        {
            ...
            if (uname != "" && pass != "")
            {
                ...
                string query = "select * from playerregister where username = '" + uname + "' and password = '" + pass + "'";
                ...
                {
                    // connect new form
                    Session["playername"] = username.Text;
