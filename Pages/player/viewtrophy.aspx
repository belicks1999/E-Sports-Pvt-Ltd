<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewtrophy.aspx.cs" Inherits="E_Sports_Pvt_Ltd.Pages.player.viewtrophy" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>View Trophy</title>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      <li><a href="../index.aspx"><span class="glyphicon glyphicon-user"></span> Logout</a></li>
        ...
        <h3 style="text-align:center;color:black;">Trophy Details</h3>

             <br />
             <br />
            <div class="center">
             <asp:GridView ID="trophy" runat="server" HorizontalAlign="Center" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" ForeColor="Black" Height="346px" Width="1187px" AutoGenerateColumns="False">
                 <Columns>
