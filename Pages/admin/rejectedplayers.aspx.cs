...
{
    public partial class rejectedplayers : System.Web.UI.Page
    {
        ...
        private void LoadDataGrid2()
        {
            ...
            try
            {
                ...
                cmd.CommandText = "Select * from player where status ='" + "rejected" + "'";
                cmd.ExecuteNonQuery();
                conn.Close();
        ...
        protected void sold_Click(object sender, EventArgs e)
        {
            ...
            Response.Charset = "";
            string FileName = "Esportrejected" + DateTime.Now + ".xls";
