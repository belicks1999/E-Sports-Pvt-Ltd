<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminlogin.aspx.cs" Inherits="E_Sports_Pvt_Ltd.Pages.admin.admin" %>
...
<body>
    ...
    <h2>Admin Login<label for="username"><asp:Label ID="error" runat="server" style="color: #FFFFFF; font-size: x-large"></asp:Label>
        </label>
         </h2>
