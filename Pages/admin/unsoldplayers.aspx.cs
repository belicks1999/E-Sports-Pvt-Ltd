...
{
    public partial class unsoldplayers : System.Web.UI.Page
    {
        ...
        private void LoadDataGrid2()
        {
            ...
            try
            {
                ...
                cmd.CommandText = "Select * from player where status ='" + "unsold" + "'";
                cmd.ExecuteNonQuery();
                conn.Close();
        ...
        protected void sold_Click(object sender, EventArgs e)
        {
            ...
            Response.Charset = "";
            string FileName = "Esportunsold" + DateTime.Now + ".xls";
